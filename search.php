...
$searchedQuery=$_GET['q'];
$select = $conn->prepare("SELECT * FROM ocaladb WHERE title LIKE '%$searchedQuery%'");
$select->execute();
...
<body dir="rtl">
  ...
  <div class="container">
      ...
      <div class="serchinsid">
        ...
        <form action="" method="post" class="myform">
          ...
          <div class="col-12 col-lg-1">
            <input type="submit" id="search-btn" name="search-bt" class="btn btn-info sub" value="جستجو">
          </div>
        </form>
      </div>
    </div>
    ...
    <h3 id="newArticeTitle">نتایج جستجو</h3>
