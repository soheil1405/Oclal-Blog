...
$select=$conn->prepare("SELECT * FROM writer");
$select->execute();
...
?>
    <h4 style="text-align:center;">مشاهده نویسندگان </h4>
  ...
  <thead class="thead-dark">
    ...
    <tr>
      ...
      <td><?= $writer['bio'] ?></td>      
      <td><img src="<?= $writer['profileImage']; ?>" alt="" height="100px"></td>      
      <td><a href="writersController.php?id=<?= $writer['id']; ?>&what=delete" class="btn btn-danger">حذف</a><a href="writersController.php?id=<?= $writer['id']; ?>&what=edit">ویرایش</a></td>
    </tr>
    </tbody>   
    <?php endforeach ?>
