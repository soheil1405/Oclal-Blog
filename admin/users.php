...
?>
    <h4 style="text-align:center;">مشاهده کاربران </h4>
  ...
  <thead class="thead-dark">
    ...
    <tr>
      ...
      <td><?= $user['email'] ?></td>
      <td><?= $user['pass'] ?></td>       
      <td><a href="usersController.php?id=<?= $user['id']; ?>&what=delete" class="btn btn-danger">حذف</a><a href="usersController.php?id=<?= $user['id']; ?>&what=edit">ویرایش</a></td>
    </tr>
    </tbody>   
    <?php endforeach ?>
